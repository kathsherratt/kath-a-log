...
- **Shed** -- holding space for things not needed today
- **Seed tray** -- longer-term plans and protocols, germinating
...
- 3-day stale rule: if a task hasn't moved in 3 days,
  ask whether it can be pruned smaller or moved to the shed
...
Capture distractions to the Shed section of today.md.
...
| landscaping/seed-tray.md | Project plans and protocols. |
...
- All tasks completed ("clean bed"): +2 bonus
...
moving? Is there a 15-minute version of this task?
```
...
- Do not plan long-term strategy (that is Kath's job, in landscaping/)
